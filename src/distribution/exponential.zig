...
comptime {
    @export(&density, .{ .name = "rv_exponential_density" });
    @export(&probability, .{ .name = "rv_exponential_probability" });
    @export(&survival, .{ .name = "rv_exponential_survival" });
    @export(&quantile, .{ .name = "rv_exponential_quantile" });
}
